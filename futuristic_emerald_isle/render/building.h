...
private:
	...
	// Specify which vertices to connect to form triangles for each face. Each face has two triangles.
	...
	GLfloat uv_buffer_data[48] = {
		// Front
		0.0f, 1.0f,			// Bottom-left		U (horizontal), V (vertical)
		1.0f, 1.0f,			// Bottom-right		U, V
		1.0f, 0.0f,			// Top-right
		0.0f, 0.0f,			// Top-left
		// Back
		0.0f, 1.0f,
